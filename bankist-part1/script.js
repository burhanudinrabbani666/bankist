...
const ownerEatTooMuch = dogs
  .filter((dog) => {
    if (dog.curFood > dog.recomendedFood) return dog;
  })
...
const ownersEatTooLittle = dogs.filter((dog) => {
  if (
    ...
    dog.recomendedFood - dog.recomendedFood * 0.1
  )
    return dog;
});
...
console.log(dogs[0].recomendedFood);
console.log(dogs[0].recomendedFood * 0.1);
